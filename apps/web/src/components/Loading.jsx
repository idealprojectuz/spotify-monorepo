...
export const Loading = () => {
  ...
  return (
    <div
      id="loading-wrapper"
      className="fixed z-[99]  w-full h-screen flex-col   left-0 bottom-0 bg-[#ffffff06] backdrop-blur-[60px] overflow-hidden  flex justify-center items-center">
      <p className="flex items-center">
        ...
        <span className="text-[38px] translate-y-[1.3px] font-bold text-[#0dc43b]">
          UZ
        </span>
      </p>
    </div>
